...
our $DL_DIR = "/data/torrents/staging"; # Set this to the folder where your torrents are downloaded to
our $SHOWS_DIR = "/data/share/shows"; # Set this to the directory where you store your shows
our $MOVIES_DIR = "/data/share/movies"; # Set this to the directory where you store your movies
our $forceful = 0; # Set to 1 if you want to never be asked anything
our $anti_forceful = 0; # Set to 1 if you want to be asked to confirm everything
our $replacement = 0; # Set to 1 if you want to overwrite existing movies or tv episodes if they already exist
our $no_delete = 1; # Set to 0 if you want torrent download to be deleted if this script manages to find something in the specific download
our $commands = "";
